    ...
    <div className="bg-slate-50">
      <section>
        ...
        >
          ...
          <div
            className="col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16 md:px-0 mt-32 
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  that led to some pretty heavy scratchmarks on all of my phone cases.
